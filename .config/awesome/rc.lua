...
awful.keyboard.append_global_keybindings({
  -- Volume controls
  awful.key({}, "XF86AudioRaiseVolume", function() awful.spawn("l--volume-control change 2%+") end,
    { description = "increase volume", group = "media" }),
  awful.key({}, "XF86AudioLowerVolume", function() awful.spawn("l--volume-control change 2%-") end,
    { description = "decrease volume", group = "media" }),
  awful.key({}, "XF86AudioMute", function() awful.spawn("l--volume-control toggle") end,
  ...
  -- Brightness controls
  awful.key({}, "XF86MonBrightnessUp", function() awful.spawn("brightnessctl s +2%") end,
    { description = "increase brightness", group = "media" }),
  awful.key({}, "XF86MonBrightnessDown", function() awful.spawn("brightnessctl s 2%-") end,
    { description = "decrease brightness", group = "media" }),
  -- Screenshot
  awful.key({}, "Print", function() awful.spawn("$HOME/.local/bin/sc-printscreen") end,
