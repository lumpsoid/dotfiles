...
tag.connect_signal("request::default_layouts", function()
  awful.layout.append_default_layouts({
    ...
    awful.layout.suit.fair.horizontal, -- equal-width grid
    awful.layout.suit.magnifier,       -- focused enlarged, rest around edges
    awful.layout.suit.max,             -- fullscreen stack (monocle)
